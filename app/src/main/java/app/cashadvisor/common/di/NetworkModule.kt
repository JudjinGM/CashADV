...
import app.cashadvisor.authorization.data.dataSource.impl.NetworkConnectionProviderImpl
import app.cashadvisor.authorization.data.dataSource.api.NetworkConnectionProvider
import app.cashadvisor.common.data.network.ErrorCodeMapper
...
class NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideErrorCodeMapper(): ErrorCodeMapper {
